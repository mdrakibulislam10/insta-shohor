...
const addToLiked = (id) => {
  ...
  if (!likedPostsId.includes(id)) {
    ...
    const idIndex = (likedPostsId.indexOf(id));
    const forwardElement = likedPostsId.slice(0, idIndex);
    const backElement = likedPostsId.slice(idIndex + 1, likedPostsId.length + 1)
    likedPostsId = [...forwardElement, ...backElement];
  }
...
const displayContent = (text) => {
  ...
  // }
  // else {
  //   console.log(text.slice(0, 30) + "<span class='fw-bold'>... read more</span>");
  // }
  // bug fixed
